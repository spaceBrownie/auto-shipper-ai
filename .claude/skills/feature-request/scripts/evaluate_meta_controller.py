#!/usr/bin/env python3
"""
Scenario-driven evaluator for meta_controller.py.
...
DEFAULT_SCENARIOS = (
    ".claude/skills/feature-request/references/meta-controller-scenarios.json"
)
DEFAULT_WORKFLOW = ".claude/skills/feature-request/references/feature-workflow.yaml"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate meta-controller with scenario fixtures.")
    parser.add_argument(
        "--scenarios",
        type=str,
...
def main() -> None:
    ...
    if args.json:
        ...
        print("Meta-Controller Evaluation")
        print("=" * 28)
