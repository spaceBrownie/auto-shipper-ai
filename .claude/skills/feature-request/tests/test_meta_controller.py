...
WORKFLOW_PATH = ".claude/skills/feature-request/references/feature-workflow.yaml"
SCENARIO_PATH = ".claude/skills/feature-request/references/meta-controller-scenarios.json"


class MetaControllerDecisionTests(unittest.TestCase):
    def test_phase_gate_blocks_parallel_before_phase4(self):
