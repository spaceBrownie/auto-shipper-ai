...
/**
 * BR-2: Blank-credential guard for FedExRateAdapter.
 *
 ...
 *
 * These tests instantiate FedExRateAdapter with blank credentials and verify
 ...
 */
class FedExRateAdapterBlankCredentialTest {
    ...
    fun `getRate throws ProviderUnavailableException when clientId is blank`() {
        val adapter = FedExRateAdapter(
            fedexRestClient = dummyRestClient,
            clientId = "",
